          ...
          <Row gutter={12}>
            <Col span={24}>
              <Form.Item
                ...
                rules={[{ required: true, message: t('required') }]}
              >
                <Select className='w-100' placeholder="Select shop type">
                  <Select.Option value={0}>Retail</Select.Option>
                  <Select.Option value={1}>Restaurant</Select.Option>
                </Select>
              </Form.Item>
            </Col>
          </Row>
