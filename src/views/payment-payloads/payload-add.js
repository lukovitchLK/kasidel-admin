...
import OzowLogo from 'assets/images/ozow.svg';
...
export default function PaymentPayloadAdd() {
  ...
  const handleAddIcon = (data) => {
    switch (data) {
      ...
      case 'Ozow':
        return <img src={OzowLogo} alt='img' width='80' height='80' />;
      default:
        return null;
    }
  };
        ...
        <Row gutter={12}>
          ...
          activePayment?.label === 'Wallet' ? (
            ...
            <>
              ...
              ) : activePayment?.label === 'Ozow' ? (
                <>
                  <Col span={12}>
                    <Form.Item
                      label={t('ozow.site.code')}
                      name='ozow_site_code'
                      rules={[{ required: true, message: t('required') }]}
                    >
                      <Input placeholder='Enter OZOW Site Code' />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item
                      label={t('ozow.api.key')}
                      name='ozow_api_key'
                      rules={[{ required: true, message: t('required') }]}
                    >
                      <Input placeholder='Enter OZOW API Key' />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item
                      label={t('ozow.private.key')}
                      name='ozow_private_key'
                      rules={[{ required: true, message: t('required') }]}
                    >
                      <Input
                        placeholder='Enter OZOW Private Key'
                        type='password'
                      />
                    </Form.Item>
                  </Col>
