...
export const MAP_API_KEY =
  process.env.REACT_APP_MAP_API_KEY || 'AIzaSyB-_Fyqw7FJJxTpt7MjwYvuUZJQa065tTs';
...
export const API_KEY =
  process.env.REACT_APP_API_KEY || 'AIzaSyC7sJztdLGUDeaVRp4JzGQqkd1SAl8Mxzw';
...
export const RECAPTCHASITEKEY =
  process.env.REACT_APP_RECAPTCHA_SITE_KEY || '6LdYojEqAAAAAFEACPmNtOnHgukxE2S7D8oo1tiQ';
